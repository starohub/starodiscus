...
public class ContextFactory
{
     ...
     */
    protected com.starohub.discus.xml.XMLLib.Factory
        getE4xImplementationFactory()
    {
        ...
        if (isDom3Present()) {
            return com.starohub.discus.xml.XMLLib.Factory.create(
                "com.starohub.discus.xmlimpl.XMLLibImpl"
            );
        } else if (Kit.classOrNull("org.apache.xmlbeans.XmlCursor") != null) {
            return com.starohub.discus.xml.XMLLib.Factory.create(
                "com.starohub.discus.xml.impl.xmlbeans.XMLLibImpl"
            );
        } else {
            return null;
        }

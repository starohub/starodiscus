...
import com.starohub.discus.tools.shell.Global;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Global global = com.starohub.discus.tools.shell.Main.getGlobal();
        global.setIn(main.getIn());
        global.setOut(main.getOut());
        global.setErr(main.getErr());

        main.attachTo(
                com.starohub.discus.tools.shell.Main.shellContextFactory);
        ...
        com.starohub.discus.tools.shell.Main.exec(args);
    }

...
import com.starohub.discus.ast.AstRoot;
import com.starohub.discus.ast.ScriptNode;
import com.starohub.discus.debug.DebuggableScript;
import com.starohub.discus.debug.Debugger;
...
public class Context
{
    ...
    public static void addContextListener(ContextListener listener)
    {
        ...
        String DBG = "com.starohub.discus.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull(
                "com.starohub.discus.ContextFactory");
            ...
            throws ContinuationPending
    {
        ...
        return Interpreter.restartContinuation(
                (com.starohub.discus.NativeContinuation) continuation,
                this, scope, args);
    }
    ...
    private static Class<?> codegenClass = Kit.classOrNull(
                             "com.starohub.discus.optimizer.Codegen");
    private static Class<?> interpreterClass = Kit.classOrNull(
                             "com.starohub.discus.Interpreter");
